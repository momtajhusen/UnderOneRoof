...
// create a component
const B2BOrderDetails = ({navigation}) => {
               ...
               <ScrollView>
                <View style={styles.ContentContainer}>
                    ...
                    <View style={{padding:rw(3), backgroundColor:"white", borderRadius:10, flexDirection:"row", justifyContent:"space-between", alignItems:"center"}}>
                       ...
                       <TouchableOpacity onPress={()=>navigation.navigate('B2BRatingAndReviews')} style={{width:rw(25), paddingVertical:rh(1), borderRadius:10, backgroundColor:"#FF3131"}}>
